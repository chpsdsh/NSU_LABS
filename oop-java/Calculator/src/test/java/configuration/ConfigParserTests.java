...
import exceptions.ParserConfigLoadException;
...
public class ConfigParserTests {
    ...
    void testInvalidConfigurationFileName() {
        ...
        Exception exception = assertThrows(ParserConfigLoadException.class, () -> confParser.ParseAndExecute(commandProcessor));
        assertTrue(exception.getMessage().contains("Configuration file not found"));
    }

    @Test
    void testConfigFileProcessing() {
